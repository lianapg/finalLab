...
void fillLetter(int x, int y, unsigned int fillcolor) {
  fillRect(x, y, letterWidth, letterHeight, fillcolor);
}

void drawBrick(int x, int y, int brick_width, int brick_height, unsigned int fillcolor) {
  fillRect(x, y, brick_width, brick_height, fillcolor);
}
