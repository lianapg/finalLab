...
static const unsigned char STARTSTRING[] = {'P','r','e','s','s',' ','M','U','T','E',' ','t','o',' ',' ',' ','b','e','g','i','n'};

//"Game over, press LAST to reset"
static const unsigned char ENDSTRING[] = {'G','a','m','e',' ','o','v','e','r',',',' ','p','r','e','s','s',' ','L','A','S','T',' ','t','o',' ','r','e','s','e','t'};


static const unsigned char STARTSCORESTRING[] = {'S','c','o','r','e',' ','=',' ','0'};

static const unsigned char SCORESTRING[] = {'S','c','o','r','e',' ','=',' '};
...
void updateScore(int points) {
    int x = 115;
    int y = 0;
    fillLetter(x,y, BLACK);
    drawChar(x, y, '0' + points, RED, RED, 1);
}
...
void printSTARTscreen() {
    ...
    for(i = 0; i < sizeof(STARTSTRING); i++) {
        ...
        //fillScreen(BLACK);
        drawChar(x, y, STARTSTRING[i], RED, RED, 1);
        x = x + 8;
        if(x >= 128) {
            x = 0;
            y = y + 10;
...
void printENDscreen(int points) {
    ...
    for(i = 0; i < sizeof(ENDSTRING); i++) {
        ...
        //fillScreen(BLACK);
        drawChar(x, y, ENDSTRING[i], RED, RED, 1);
        x = x + 8;
        if(x >= 128) {
            x = 0;
            y = y + 10;
    ...
    for(i = 0; i < sizeof(SCORESTRING); i++) {

        drawChar(x, y, SCORESTRING[i], RED, RED, 1);
        x = x + 8;
        if(x >= 128) {
            x = 0;
            y = y + 10;
...
void printStartScore() {
    int i;
    int x = 55, y = 0;
    for(i = 0; i < sizeof(STARTSCORESTRING); i++) {
        //fillScreen(BLACK);
        drawChar(x, y, STARTSCORESTRING[i], RED, RED, 1);
        x = x + 8;
        if(x >= 128) {
            x = 0;
            y = y + 10;
